...
public class HistogramEqualizationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_grayscale_eq = (ImageView) findViewById(R.id.iv_grayscale_eq);
        iv_hist_bgr = (ImageView) findViewById(R.id.iv_hist_bgr);
        iv_hist_grayscale = (ImageView) findViewById(R.id.iv_hist_grayscale);
        iv_hist_grayscale_eq = (ImageView) findViewById(R.id.iv_hist_grayscale_eq);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        if (requestCode == PICK_IMAGE && resultCode == RESULT_OK && data != null) {
            ...
            bmp_grayscale_eq = Pengcit.getEqualizeBitmap(bmp_grayscale);
            ...
            bmp_hist_grayscale_eq = Pengcit.getHistogramBitmap(bmp_grayscale_eq, 150, 150);

            iv_bgr.setImageBitmap(bmp_bgr);
            iv_grayscale.setImageBitmap(bmp_grayscale);
            iv_grayscale_eq.setImageBitmap(bmp_grayscale_eq);

            iv_hist_bgr.setImageBitmap(bmp_hist_bgr);
            iv_hist_grayscale.setImageBitmap(bmp_hist_grayscale);
            iv_hist_grayscale_eq.setImageBitmap(bmp_hist_grayscale_eq);
        }
